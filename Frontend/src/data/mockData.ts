...
/** Open defects by module (portfolio); aligns with defectMetrics.openBugs total. */
export const defectModuleOpenBugs = [
  { module: 'Payments', openBugs: 28 },
  { module: 'Mobile Core', openBugs: 24 },
  { module: 'Authentication', openBugs: 22 },
  { module: 'Reporting', openBugs: 18 },
  { module: 'Checkout', openBugs: 15 },
  { module: 'Admin Portal', openBugs: 14 },
  { module: 'API Gateway', openBugs: 12 },
  { module: 'Data Export', openBugs: 10 },
  { module: 'Notifications', openBugs: 8 },
]

/** Active-defect priority mix (portfolio); aligns with defectMetrics.openBugs total. */
export const defectPriorityDistribution = [
  { name: 'Blocker', value: 8, color: '#7f1d1d' },
  { name: 'Critical', value: 14, color: '#ef4444' },
  { name: 'High', value: 38, color: '#f97316' },
  { name: 'Medium', value: 55, color: '#3b82f6' },
...
export const defects: Defect[] = [
  {
    id: 'BUG-4821',
    title: 'Session timeout not enforced on payment flow',
    project: 'PatriotPay',
    sprintId: 'pp-s18',
    module: 'Checkout',
    severity: 'critical',
  ...
  {
    id: 'BUG-4819',
    title: 'OAuth redirect fails on Safari mobile',
    project: 'TBR',
    sprintId: 'tbr-s15',
  ...
  {
    id: 'BUG-4815',
    title: 'Duplicate charge on retry payment',
    project: 'PatriotPay',
    sprintId: 'pp-s17',
    module: 'Payments',
    severity: 'high',
  ...
  {
    id: 'BUG-4808',
    title: 'Grid widget renders stale data after refresh',
    project: '40 Grid',
    sprintId: 'fg-s9',
    module: 'Reporting',
    severity: 'medium',
  ...
  {
    id: 'BUG-4802',
    title: 'AI inference pipeline fails on edge nodes',
    project: 'Operator AI',
    sprintId: 'oai-s24',
    module: 'Mobile Core',
    severity: 'high',
  ...
  {
    id: 'BUG-4798',
    title: 'Export CSV missing currency formatting',
    project: 'ACL',
    sprintId: 'acl-s7',
    module: 'Data Export',
    severity: 'low',
  ...
  {
    id: 'BUG-4791',
    title: 'Player stats not updating after live match sync',
    project: 'Sportspass',
    sprintId: 'sp-s10',
    module: 'Data Sync',
    severity: 'high',
  ...
  {
    id: 'BUG-4785',
    title: 'Admin role assignment not persisting across sessions',
    project: 'Admins',
    sprintId: 'adm-s3',
    module: 'Admin Portal',
    severity: 'medium',
...
export const testExecutionMetrics: TestExecutionMetrics = {
  totalTestCases: 12480,
  executedTests: 10842,
  passedTests: 9912,
  failedTests: 687,
  blockedTests: 243,
...
export const testExecutions: TestExecution[] = [
  {
    id: 'TE-9021',
    name: 'Regression Suite v4.2',
    project: 'Operator AI',
    sprintId: 'oai-s24',
    suite: 'Full Regression',
    status: 'passed',
    executedAt: '2026-06-01 09:15',
    duration: '2h 14m',
  },
  {
    id: 'TE-9020',
    name: 'Payment Flow Smoke',
    project: 'PatriotPay',
    sprintId: 'pp-s18',
    suite: 'Smoke',
    status: 'failed',
    executedAt: '2026-06-01 08:42',
    duration: '45m',
  },
  {
    id: 'TE-9019',
  ...
  },
  {
    ...
    suite: 'Integration',
    status: 'blocked',
    executedAt: '2026-05-31 14:20',
    duration: '32m',
  },
  {
    id: 'TE-9017',
    name: 'Grid Rendering Tests',
    project: '40 Grid',
    sprintId: 'fg-s9',
    suite: 'UI Components',
    status: 'passed',
    executedAt: '2026-05-31 11:05',
    duration: '58m',
  },
  {
    id: 'TE-9016',
    name: 'Inventory Smoke Tests',
    project: 'ACL',
    sprintId: 'acl-s7',
    suite: 'Smoke',
    status: 'passed',
    executedAt: '2026-05-30 15:00',
    duration: '28m',
  },
  {
    id: 'TE-9015',
    name: 'Match Feed E2E Tests',
    project: 'Sportspass',
    sprintId: 'sp-s10',
    suite: 'Full Regression',
    status: 'failed',
    executedAt: '2026-05-30 10:30',
    duration: '1h 42m',
  },
  {
    id: 'TE-9014',
    name: 'Hub Navigation Tests',
    project: 'York IE Hub',
    sprintId: 'yih-s6',
    suite: 'UI Components',
    status: 'passed',
    executedAt: '2026-05-29 14:00',
    duration: '52m',
  },
  {
    id: 'TE-9013',
    ...
    suite: 'Integration',
    status: 'passed',
    executedAt: '2026-05-29 09:45',
    duration: '37m',
  },
]

export const automationMetrics: AutomationMetrics = {
  automatedTestCases: 8486,
  manualTestCases: 3994,
  automationCoverage: 68,
  automationPassRate: 93.2,
  flakyTests: 47,
  stabilityRate: 96.8,
  avgExecutionTime: '18m 42s',
}

export const moduleAutomationCoverage: ModuleAutomationCoverage[] = [
...
export const flakyTests: FlakyTest[] = [
  {
    id: 'FT-101',
    name: 'checkout.payment.retry.spec.ts',
    project: 'PatriotPay',
    sprintId: 'pp-s18',
    failureRate: 18.4,
    lastRun: '2026-06-01',
  ...
  {
    id: 'FT-102',
    name: 'auth.sso.redirect.spec.ts',
    project: 'TBR',
    sprintId: 'tbr-s15',
    failureRate: 14.2,
    lastRun: '2026-06-01',
  ...
  {
    id: 'FT-103',
    name: 'grid.widget.refresh.spec.ts',
    project: '40 Grid',
    sprintId: 'fg-s9',
    failureRate: 9.8,
    lastRun: '2026-05-31',
  ...
  {
    id: 'FT-104',
    name: 'operator.inference.pipeline.spec.ts',
    project: 'Operator AI',
    sprintId: 'oai-s24',
    failureRate: 7.5,
    lastRun: '2026-05-31',
  ...
  {
    id: 'FT-105',
    name: 'sportspass.match.feed.sync.spec.ts',
    project: 'Sportspass',
    sprintId: 'sp-s10',
    failureRate: 5.2,
    lastRun: '2026-05-30',
...
export const defectTrend: TrendPoint[] = [
...
export const testTrend: TrendPoint[] = [
  { label: 'Week 1', value: 88, secondary: 91 },
  { label: 'Week 2', value: 90, secondary: 89 },
  { label: 'Week 3', value: 87, secondary: 92 },
  { label: 'Week 4', value: 91, secondary: 93 },
  { label: 'Week 5', value: 89, secondary: 91 },
  { label: 'Week 6', value: 92, secondary: 94 },
]

export const automationTrend: TrendPoint[] = [
  { label: 'Jan', value: 58 },
  { label: 'Feb', value: 61 },
  { label: 'Mar', value: 63 },
  { label: 'Apr', value: 65 },
...
export const qualityScoreTrend: TrendPoint[] = [
  { label: 'Jan', value: 76, periodStart: '2026-01-01' },
  { label: 'Feb', value: 78, periodStart: '2026-02-01' },
  { label: 'Mar', value: 79, periodStart: '2026-03-01' },
  { label: 'Apr', value: 80, periodStart: '2026-04-01' },
  { label: 'May', value: 81, periodStart: '2026-05-01' },
  { label: 'Jun', value: 82, periodStart: '2026-06-01' },
]
